...
describe("buildApplicationExperiencePromptAppendix", () => {
  ...
  it("adds COLORS advisory rubric guidance for the forum application flow", () => {
    ...
    expect(appendix).toContain("private, revisable routing hypothesis")
    expect(appendix).toContain("first routing inflection point")
    ...
    expect(appendix).toContain("Do not require artists or enthusiasts")

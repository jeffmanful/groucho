  ...
  if (app.required_signals?.length) {
    ...
    if (isColorsForumApplication(app.required_signals)) {
      sections.push(
        ...
        "- Applicant orientation is a private, revisable routing hypothesis, not a fixed identity label. Follow explicit evidence, allow artist/curator/enthusiast hybrids, and change route when the applicant reveals another relationship to music.",
        ...
        "- Do not require artists or enthusiasts to answer the unfinished-music feedback scenario. Reserve that route for curator, scene, feedback, or organising evidence. Do not treat absent curation, multiplier, maker, or formal scene activity as a weakness for an enthusiast.",
